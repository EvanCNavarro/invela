...
import { Key, Send, Lock, FileText, Layers, ShieldCheck } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                Invela's Data Access Grants Service simplifies and streamlines data access management for financial institutions and third parties, with a secure SaaS solution that makes handling data access tokens and permissions intuitive and efficient.
              </motion.p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Implement granular access controls with data minimization principles, ensuring third parties only access the specific data they need."
              }
            ].map((step, index) => (
              <motion.div 
                key={index}
          ...
          <div className="flex justify-center mt-12">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-4 mt-2 text-center">Comprehensive Audit & Reporting</h3>
              <p className="text-gray-600 text-center">
                Track all data access activities with detailed audit trails and reporting capabilities, making regulatory compliance straightforward and demonstrable.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <motion.h2 
              ...
              className="text-3xl font-bold mb-6"
            >
              Why choose Invela Data Access Grants?
            </motion.h2>
          ...
          >
            {[
              ...
              >
                <Key className="h-6 w-6 text-blue-500 mt-0.5 mr-3 flex-shrink-0" />
