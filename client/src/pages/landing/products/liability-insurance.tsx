          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <motion.div 
                ...
                className="mb-6"
              >
                <SectionTitleChip title="Invela Liability Insurance" sectionId="overview" className="bg-blue-100" />
              </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center mt-12">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-4 mt-2 text-center">Claims Management & Resolution</h3>
              <p className="text-gray-600 text-center">
                Our comprehensive claims process is designed to efficiently handle incidents with standardized procedures and clear timelines, ensuring minimal disruption to your operations.
              </p>
            </motion.div>
          </div>
        </div>
