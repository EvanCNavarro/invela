          ...
          <div className="max-w-5xl mx-auto text-center mb-16">
            ...
            <div className="mb-10">
              ...
              >
                ...
                <motion.div variants={fadeIn} className="flex flex-col items-center" id="leader-1">
                  <div className="w-36 h-36 rounded-full overflow-hidden shadow-md mb-4 border-2 border-gray-100 flex items-center justify-center bg-white">
                    <img src="/images/company/leadership/leadership_01_ssmith.png" alt="Steve Smith" className="w-full h-full object-cover" style={{ objectPosition: 'center 20%' }} />
                  </div>
                ...
                <motion.div variants={fadeIn} className="flex flex-col items-center" id="leader-2">
                  <div className="w-36 h-36 rounded-full overflow-hidden shadow-md mb-4 border-2 border-gray-100 flex items-center justify-center bg-white">
                    <img src="/images/company/leadership/leadership_02_ncoffing.png" alt="Nathanael Coffing" className="object-cover" style={{ width: '140%', height: '140%', objectPosition: 'center 30%' }} />
                  </div>
                ...
                <motion.div variants={fadeIn} className="flex flex-col items-center" id="leader-3">
                  <div className="w-36 h-36 rounded-full overflow-hidden shadow-md mb-4 border-2 border-gray-100 flex items-center justify-center bg-white">
                    <img src="/images/company/leadership/leadership_03_pmcfarland.png" alt="Preston McFarland" className="object-cover" style={{ width: '140%', height: '140%', objectPosition: 'center 30%' }} />
                  </div>
                ...
                <motion.div variants={fadeIn} className="flex flex-col items-center" id="leader-4">
                  <div className="w-36 h-36 rounded-full overflow-hidden shadow-md mb-4 border-2 border-gray-100 flex items-center justify-center bg-white">
                    <img src="/images/company/leadership/leadership_04_dnehrebecki.png" alt="Darek Nehrebecki" className="object-cover" style={{ width: '140%', height: '140%', objectPosition: 'center 30%' }} />
                  </div>
            ...
            >
              <motion.div variants={fadeIn} className="flex flex-col items-center" id="leader-5">
                <div className="w-36 h-36 rounded-full overflow-hidden shadow-md mb-4 border-2 border-gray-100 flex items-center justify-center bg-white">
                  <img src="/images/company/leadership/leadership_05_gsulbaran.png" alt="Gaby Sulbaran" className="object-cover" style={{ width: '140%', height: '140%', objectPosition: 'center 30%' }} />
                </div>
              ...
              <motion.div variants={fadeIn} className="flex flex-col items-center" id="leader-6">
                <div className="w-36 h-36 rounded-full overflow-hidden shadow-md mb-4 border-2 border-gray-100 flex items-center justify-center bg-white">
                  <img src="/images/company/leadership/leadership_06_dkurbur.png" alt="Dev Kurbur" className="object-cover" style={{ width: '140%', height: '140%', objectPosition: 'center 30%' }} />
                </div>
              ...
              <motion.div variants={fadeIn} className="flex flex-col items-center" id="leader-7">
                <div className="w-36 h-36 rounded-full overflow-hidden shadow-md mb-4 border-2 border-gray-100 flex items-center justify-center bg-white">
                  <img src="/images/company/leadership/leadership_07_jwadsworth.png" alt="Jim Wadsworth" className="object-cover" style={{ width: '140%', height: '140%', objectPosition: 'center 30%' }} />
                </div>
