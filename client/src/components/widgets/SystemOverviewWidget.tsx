...
const calculatePersonaStats = (companies: any[], accreditations: any[], timeframe: TimeframeOption) => {
  ...
  const invela = companies?.filter(c => c.category === 'Invela')?.length || 0;
...
export function SystemOverviewWidget({ className = '' }: SystemOverviewWidgetProps) {
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-4 rounded-lg border border-purple-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-purple-700">Total Companies</p>
                <p className="text-2xl font-bold text-purple-900">{stats.totalCompanies.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-green-50 to-green-100 p-4 rounded-lg border border-green-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-700">Data Providers</p>
                <p className="text-2xl font-bold text-green-900">{stats.dataProviders.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-blue-700">Data Recipients</p>
                <p className="text-2xl font-bold text-blue-900">{stats.dataRecipients.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-indigo-100 p-4 rounded-lg border border-indigo-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-indigo-700">Active Accreditations</p>
                <p className="text-2xl font-bold text-indigo-900">{stats.totalAccreditations.toLocaleString()}</p>
              </div>
