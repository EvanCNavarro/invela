...
export function DemoHeader({ className }: DemoHeaderProps) {
  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <div className="bg-transparent rounded-t-lg overflow-hidden p-1">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
          
          {/* Back to Login Button - positioned in first column like changelog */}
          <button
            onClick={handleBackToLogin}
            className="p-3 bg-transparent hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-inset transition-all duration-200 group rounded-md"
          >
