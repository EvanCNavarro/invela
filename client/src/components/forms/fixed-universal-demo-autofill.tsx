...
/**
 * Fixed complete handleDemoAutoFill implementation 
...
export const createDemoAutoFillHandler = ({
  ...
  const handleDemoAutoFill = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        // For Open Banking forms, use the form service's bulkUpdate method
          ...
          try {
            ...
            logger.error('[UniversalForm] Error during bulk update:', innerError);
        ...
        logger.error('[UniversalForm] Auto-fill inner error:', innerError);
        toast({
          variant: "destructive",
          title: "Auto-Fill Failed",
      ...
      logger.error('[UniversalForm] Auto-fill outer error:', err);
      toast({
        variant: "destructive",
        title: "Auto-Fill Failed",
