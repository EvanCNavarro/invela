...
exports.companySearchSchema = exports.searchCompanyInfo = exports.openaiOnlySearch = exports.googleOnlySearch = void 0;
...
const googleOnlySearch = async (companyName) => {
    ...
    try {
        ...
        const scoredResults = searchResults.flatMap(result => result.items?.map(item => ({
            ...item,
...
exports.googleOnlySearch = googleOnlySearch;
// Enhanced logging for OpenAI search
const openaiOnlySearch = async (companyName) => {
...
exports.openaiOnlySearch = openaiOnlySearch;
...
const searchCompanyInfo = async (companyName) => {
    ...
    try {
        ...
        const googleData = await (0, exports.googleOnlySearch)(companyName);
        ...
        const cleanedData = await (0, openai_1.validateAndCleanCompanyData)(normalizedData);
        const endTime = Date.now();
...
exports.companySearchSchema = zod_1.z.object({
