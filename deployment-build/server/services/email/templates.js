...
const invitationTemplateSchema = zod_1.z.object({
    ...
    senderCompany: zod_1.z.string().min(1, "Sender company is required"),
    targetCompany: zod_1.z.string().min(1, "Target company is required"),
    inviteUrl: zod_1.z.string().url("Valid invite URL is required"),
    code: zod_1.z.string().optional(),
    inviteType: zod_1.z.enum(['user', 'fintech']).default('user')
});
...
function getEmailTemplate(templateName, data) {
    ...
    try {
        ...
        const validationResult = exports.emailTemplateSchema.safeParse(emailTemplate);
