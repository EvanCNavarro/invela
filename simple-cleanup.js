/**
 * Simple Deployment Cleanup Script
 * 
...
function main() {
  ...
  try {
    ...
    execSync('find . -maxdepth 1 -type f -name "*.js" -not -name "index.js" -not -name "simple-cleanup.js" -not -name "deployment-server.js" -not -name "verify-deployment.js" -not -name "prepare-for-deployment.js" | xargs -I{} mv {} deployment-excluded/scripts/ 2>/dev/null || true');
    success('Moved utility scripts to deployment-excluded directory');
  } catch (err) {
